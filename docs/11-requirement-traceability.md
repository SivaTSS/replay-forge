...
| Model-free deterministic replay | Replay §8–10 | Dependency guard and network denial | `replay-success` |
| Business outcome | Replay §12–13 | Member-not-found E2E | `replay-member-not-found` |
...
| Structured observability | Architecture §7; Testing §4 | Event schema/order tests | Every `events.jsonl` |
...
| Multi-tenant reuse | Artifact §5; UX §13 | Two-variant E2E | `tenant-reuse` |
