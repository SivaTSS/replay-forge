...
uv run mypy backend/src backend/tests scripts/verify_evidence.py scripts/export_evidence.py scripts/verify_evidence_bundles.py scripts/capture_handoff_run.py
